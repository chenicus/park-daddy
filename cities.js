...
export const CITIES = {
  vancouver: {
    ...
    data: [
      ...
      { url: 'data/free.json?v=3', kind: 'free' },
      { url: 'data/west-end-plateau.json?v=9', kind: 'west-end' },
      { url: 'data/davie-beach.json?v=6', kind: 'west-end' },
      { url: 'data/denman-west.json?v=4', kind: 'west-end' },
